...
var LWS = module.exports = function(opts) {
  var self = this;
  self.opts = {
    port: 3000,
...
LWS.prototype.handle = function(req, res) {
  var self = this;
  ...
  res.send = function(status, body) {
    ...
    if (typeof body !== 'string') console.log('EGHGGG', body);
    res.end(body);
  };
...
LWS.prototype.run = function(req, res, chain) {
  var self = this;
...
LWS.prototype.use = function(fn) {
  var self = this;
  self.middleware.push(fn);
};

LWS.prototype.before = function(fn) {
  var self = this;
  self.beforeList.push(fn);
};

LWS.prototype.after = function(fn) {
  var self = this;
  self.afterList.push(fn);
};

LWS.prototype.route = function(method, url, fns) {
  var self = this;
